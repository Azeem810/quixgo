          ...
          <Card bg="white" zIndex={-1} boxShadow="0 0 10px rgba(0, 0, 0, 0.3)">
            ...
            <CardBody>
              <Heading as="h2" alignItems="center" gap={2} py={2} fontSize={18}>
                B2C              </Heading>
              <Text fontSize={15}>
              B2C, or business-to-consumer, is one of the most popular types of e-commerce businesses that cater directly to consumers.
              </Text>
            </CardBody>
          </Card>
        </SimpleGrid>
